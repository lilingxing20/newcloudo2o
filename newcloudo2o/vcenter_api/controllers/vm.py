...
class DcVmController(rest.RestController):
...
class DsVmController(rest.RestController):

    def __init__(self, tenant_id, ds_name):
        self.tenant_id = tenant_id
...
class HostVmController(rest.RestController):
