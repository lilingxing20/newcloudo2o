...
from newcloudo2o.vcenter_api.controllers import root
from newcloudo2o.vcenter_api.controllers import root_versions
...
def setup_app(*args, **kwargs):
    config = {
        ...
        'app': {
            'root': 'newcloudo2o.vcenter_api.controllers.root.RootController',
            'modules': ['newcloudo2o.vcenter_api'],
            'errors': {
                400: '/error',
                '__force_dict__': True
            }
