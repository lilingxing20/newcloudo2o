...
import newcloudo2o.common.context as newcloudo2o_context
from newcloudo2o.common import exceptions
from newcloudo2o.common import resource_handle
from newcloudo2o.db import api
...
class Client(object):
    ...
    def _update_endpoint_from_keystone(self, cxt, is_internal):
        ...
        """
        if is_internal:
            admin_context = newcloudo2o_context.Context()
