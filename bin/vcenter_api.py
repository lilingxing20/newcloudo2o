...
from newcloudo2o.common import config
from newcloudo2o.common.i18n import _LI
from newcloudo2o.common.i18n import _LW
from newcloudo2o.common import restapp

from newcloudo2o.vcenter_api import app
...
def main():
    ...
    LOG.info(_LI("vCenter api on http://%(host)s:%(port)s with %(workers)s"),
             {'host': host, 'port': port, 'workers': workers})

    service = wsgi.Server(CONF, 'newcloudo2o vCenter_API',
